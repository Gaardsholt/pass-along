...
func TestLoadConfigAsExpected(t *testing.T) {
	// arrange
	os.Clearenv()
	_ = os.Setenv("SERVER_SALT", "0123456789abcdef0123456789abcdef")
	_ = os.Setenv("DATABASE_TYPE", "redis")
	...
	assert.Equal(t, "0123456789abcdef0123456789abcdef", Config.ServerSalt)
}
